...
const TOURS = {
  agency: [
    ...
    { icon: "⚙️", title: "Paramètres & Abonnement", desc: "Gérez votre profil, votre abonnement (Starter 249€, Pro 549€, Business 749€) et vos préférences de strikes automatiques." },
  ],
  clipper: [
